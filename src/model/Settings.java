...
public class Settings {
    ...
    public static int getSavedUserId() {
        String val = props.getProperty("savedUserId", "0");
        return Integer.parseInt(val);
    }

    public static void setSavedUserId(int userId) {
        props.setProperty("savedUserId", String.valueOf(userId));
        save();
    }

    public static void clearSavedUserId() {
        props.remove("savedUserId");
        save();
    }
}