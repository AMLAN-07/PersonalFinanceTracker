...
public class UserProfilePanel extends JPanel {
    ...
    public UserProfilePanel(User user) {
        ...
        String phoneStr = (currentUser.getPhone() != null && !currentUser.getPhone().isEmpty())
    ...
    private void refreshLabels() {
        lblIncome.setText(userProfile.getMonthlyIncome() > 0
                ? CurrencyFormatter.format(userProfile.getMonthlyIncome()) : "—");
        lblOccupation.setText(userProfile.getOccupation() != null && !userProfile.getOccupation().isEmpty()
                ? userProfile.getOccupation() : "—");
        lblGoal.setText(userProfile.getFinancialGoal() != null && !userProfile.getFinancialGoal().isEmpty()
                ? userProfile.getFinancialGoal() : "—");
        lblCountry.setText(userProfile.getCountry() != null && !userProfile.getCountry().isEmpty()
                ? userProfile.getCountry() : "—");

        // Also update phone in case it changed (rare, but just in case)
        String phoneStr = (currentUser.getPhone() != null && !currentUser.getPhone().isEmpty())
                ? currentUser.getPhone() : "—";
        lblPhone.setText(phoneStr);
    }
}