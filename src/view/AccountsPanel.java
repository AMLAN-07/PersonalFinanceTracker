...
public class AccountsPanel extends JPanel {
    ...
    private void rebuildUI() {
        ...
        // Toolbar with Add Account and Transfer Money buttons
        ...
        JButton transferBtn = UIUtils.accentButton("Transfer Money", UIUtils.ORANGE);
        ...
        totalAssetsLabel = new JLabel(CurrencyFormatter.format(totalAssets));
        ...
        totalLiabilitiesLabel = new JLabel("-" + CurrencyFormatter.format(totalLiabilities));
