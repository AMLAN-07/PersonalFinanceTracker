...
import utils.ExchangeRate;   // ✅ import for conversion
import javax.swing.*;
...
public class AddTransactionDialog extends JDialog {
    ...
    // ---------- Save transaction with currency conversion ----------
    private void saveTransaction() {
        ...
        // ✅ Convert the entered display-currency amount to INR
        ...
        // ✅ Overdraft check using INR amounts
        if ("EXPENSE".equals(type) && accountId != null) {
            ...
            if (amountInINR > currentBalance) {
                JOptionPane.showMessageDialog(this,
                        "Insufficient funds!\n" +
                                "Account balance: " + CurrencyFormatter.format(currentBalance) + "\n" +
                                "Transaction amount: " + CurrencyFormatter.format(amountInINR),
        ...
        Transaction t = new Transaction(user.getId(), accountId, cardId, categoryId,
                amountInINR, type, desc, date);
