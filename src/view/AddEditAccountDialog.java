...
public class AddEditAccountDialog extends JDialog {
    ...
    public AddEditAccountDialog(JFrame parent, User user, Account account) {
        ...
        // ✅ Pre‑fill: show existing balance in the display currency
        String balanceText = "0.00";
        if (account != null) {
            double displayBal = ExchangeRate.convert(account.getBalance(),
                    CurrencyFormatter.getCurrencyCode());
            balanceText = String.valueOf(displayBal);
        }
